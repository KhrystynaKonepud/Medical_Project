...
EOF
      ...
      echo "SUCCESS: Ubuntu deployment completed! Access: http://localhost:5010"
    SHELL
  end
...
EOF
      ...
      echo "SUCCESS: Debian deployment completed! Access: http://localhost:5011"
    SHELL
  end
end